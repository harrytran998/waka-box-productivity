module.exports = (function(e, t) {
  ...
  104: function(e, t, r) {
    ...
    async function updateGist(e) {
      ...
      for (let t = 0; t < Math.min(e.data.languages.length, 5); t++) {
        ...
        const a = [i.padEnd(11), o.padEnd(14), generateBarChart(s, 21), String(s.toFixed(1)).padStart(5) + '%']
        r.push(a.join(' '))
      }
      ...
      try {
        ...
        await c.gists.update({
          gist_id: o,
          files: { [e]: { filename: `📊 Weekly development breakdown`, content: r.join('\n') } },
        })
      } catch (e) {
    ...
    function generateBarChart(e, t) {
      ...
      const s = n % 8
      return [r.substring(8, 9).repeat(i), r.substring(s, s + 1)].join('').padEnd(t, r.substring(0, 1))
    }
    ;(async () => {
      await main()
    })()
  ...
  168: function(e) {
    ...
    e.exports = e => {
      ...
      if (e.stdio && r(e)) {
        throw new Error(
          `It's not possible to provide \`stdio\` in combination with one of ${t.map(e => `\`${e}\``).join(', ')}`,
        )
      }
  ...
  215: function(e) {
    e.exports = {
      ...
      nyc: { ignore: ['test'] },
      release: {
        publish: ['@semantic-release/npm', { path: '@semantic-release/github', assets: ['dist/*', '!dist/*.map.gz'] }],
      },
    ...
    e.exports = function xhrAdapter(e) {
      return new Promise(function dispatchXhrRequest(t, p) {
        ...
        l.onreadystatechange = function handleLoad() {
          ...
          var s = { data: n, status: l.status, statusText: l.statusText, headers: r, config: e, request: l }
          i(t, p, s)
          l = null
        }
        ...
        if (n.isStandardBrowserEnv()) {
          var h = r(864)
          var f = (e.withCredentials || a(e.url)) && e.xsrfCookieName ? h.read(e.xsrfCookieName) : undefined
          if (f) {
  ...
  301: function(e, t, r) {
    ...
    function normalizePaginatedListResponse(e, t, r) {
      ...
      Object.defineProperty(r.data, f, {
        get() {
          a(e.log, new n(`[@octokit/rest] "result.data.${f}" is deprecated. Use "result.data" instead`))
          return r.data
        },
      })
      if (typeof g !== 'undefined') {
        Object.defineProperty(r.data, 'incomplete_results', {
          get() {
            s(e.log, new n('[@octokit/rest] "result.data.incomplete_results" is deprecated.'))
            return g
          },
        })
      }
      if (typeof m !== 'undefined') {
        Object.defineProperty(r.data, 'repository_selection', {
          get() {
            o(e.log, new n('[@octokit/rest] "result.data.repository_selection" is deprecated.'))
            return m
          },
        })
      }
      Object.defineProperty(r.data, 'total_count', {
        get() {
          o(e.log, new n('[@octokit/rest] "result.data.total_count" is deprecated.'))
          return h
        },
      })
    }
  ...
  323: function(e) {
    ...
    t.writable = function(e) {
      return t(e) && e.writable !== false && typeof e._write === 'function' && typeof e._writableState === 'object'
    }
    t.readable = function(e) {
      return t(e) && e.readable !== false && typeof e._read === 'function' && typeof e._readableState === 'object'
    }
    t.duplex = function(e) {
    ...
    function validate(e, t) {
      ...
      Object.keys(r).forEach(e => {
        ...
        l.forEach((r, i) => {
          ...
          if (o.required && !u) {
            throw new n(`Empty value for parameter '${l}': ${JSON.stringify(r)}`, 400, { request: t })
          }
          if (a === 'integer') {
            const e = r
            r = parseInt(r, 10)
            if (isNaN(r)) {
              throw new n(`Invalid value for parameter '${l}': ${JSON.stringify(e)} is NaN`, 400, { request: t })
            }
          }
          if (o.enum && o.enum.indexOf(String(r)) === -1) {
            throw new n(`Invalid value for parameter '${l}': ${JSON.stringify(r)}`, 400, { request: t })
          }
          if (o.validation) {
          ...
          if (a === 'object' && typeof r === 'string') {
            try {
              ...
              throw new n(`JSON parse error of value for parameter '${l}': ${JSON.stringify(r)}`, 400, { request: t })
            }
          }
          s(t, o.mapTo || l, r)
        })
  ...
  349: function(e, t, r) {
    ...
    function authenticationRequestError(e, t, r) {
      ...
      if (t.status === 401 && i && t.request && t.request.headers['x-github-otp']) {
        throw new n('Invalid one-time password for two-factor authentication', 401, { headers: t.headers, request: r })
      }
      if (typeof e.auth.on2fa !== 'function') {
        throw new n(
          '2FA required, but options.on2fa is not a function. See https://github.com/octokit/rest.js#authentication',
  ...
  454: function(e, t, r) {
      ...
      if (e instanceof n) {
        e.on('error', function(e) {
          const r =
            e.name === 'AbortError'
              ? e
              : new FetchError(`Invalid response body while trying to fetch ${t.url}: ${e.message}`, 'system', e)
          t[l].error = r
        })
      }
    }
        ...
        return consumeBody.call(this).then(function(t) {
          try {
            ...
            return Body.Promise.reject(
              new FetchError(`invalid json response body at ${e.url} reason: ${t.message}`, 'invalid-json'),
            )
          }
        })
      },
      ...
      return new Body.Promise(function(n, o) {
        ...
        if (e.timeout) {
          a = setTimeout(function() {
            s = true
            o(new FetchError(`Response timeout while trying to fetch ${e.url} (over ${e.timeout}ms)`, 'body-timeout'))
          }, e.timeout)
        }
    ...
    class Response {
      constructor() {
        ...
        this[_] = { url: t.url, status: r, statusText: t.statusText || w[r], headers: n, counter: t.counter }
      }
      get url() {
        return this[_].url || ''
      }
    ...
    class Request {
      constructor(e) {
        ...
        n = n.toUpperCase()
        if ((t.body != null || (isRequest(e) && e.body !== null)) && (n === 'GET' || n === 'HEAD')) {
        ...
        this[q] = { method: n, redirect: t.redirect || e.redirect || 'follow', headers: s, parsedURL: r, signal: o }
    ...
    function fetch(e, t) {
      ...
      return new fetch.Promise(function(r, s) {
        ...
        h.on('response', function(e) {
          ...
          if (!u.compress || u.method === 'HEAD' || o === null || e.statusCode === 204 || e.statusCode === 304) {
            l = new Response(n, i)
            r(l)
            return
          }
    ...
    class RequestError extends Error {
      constructor(e, t, r) {
        ...
        Object.defineProperty(this, 'code', {
          get() {
            s(new n.Deprecation('[@octokit/request-error] `error.code` is deprecated, use `error.status`.'))
            return t
          },
        })
  ...
  489: function(e, t, r) {
    ...
    function resolveCommandAttempt(e, t) {
      ...
      let a
      try {
        a = i.sync(e.command, { path: (e.options.env || process.env)[s], pathExt: t ? n.delimiter : undefined })
      } catch (e) {
      } finally {
        process.chdir(r)
      }
  ...
  549: function(e, t, r) {
    ...
    RedirectableRequest.prototype._processResponse = function(e) {
      ...
      if (t && this._options.followRedirects !== false && e.statusCode >= 300 && e.statusCode < 400) {
  ...
  568: function(e, t, r) {
    ...
    function parse(e, t, r) {
      ...
      t = t ? t.slice(0) : []
      r = Object.assign({}, r)
      const n = { command: e, args: t, options: r, file: undefined, original: { command: e, args: t } }
    ...
    function _objectWithoutProperties(e, t) {
      ...
      if (Object.getOwnPropertySymbols) {
        ...
        for (n = 0; n < s.length; n++)
          (r = s[n]), !(0 <= t.indexOf(r)) && Object.prototype.propertyIsEnumerable.call(e, r) && (i[r] = e[r])
      }
      return i
    }
    var s,
        ...
        function e(t) {
          _classCallCheck(this, e),
            ...
            (this.axiosConfiguration = i.create({
              ...
              headers: { Authorization: 'Basic '.concat(Buffer.from(this.apiKey).toString('base64')) },
            }))
        }
        return (
          _createClass(e, [
            ...
            },
            {
              key: 'getUserAgents',
              value: function(e) {
                return this.axiosConfiguration.get('users/'.concat(e, '/user_agents')).then(function(e) {
                  return e.data
                })
              },
            },
            ...
            },
            {
              ...
              value: function(e) {
                return this.axiosConfiguration.get('users/current/teams/'.concat(e, '/members')).then(function(e) {
                  return e.data
                })
              },
            },
            {
              ...
              value: function(e) {
                var t = e.userId,
                  r = e.teamId,
                  n = e.teamMemberId,
                  i = _objectWithoutProperties(e, ['userId', 'teamId', 'teamMemberId'])
                return this.axiosConfiguration
                  .get(
                    'users/'
                      .concat(t, '/teams/')
            ...
            },
            {
              ...
              value: function(e) {
                ...
                return this.axiosConfiguration
                  .get('users/current/teams/'.concat(t, '/members/').concat(r, '/summaries'), { params: a(n) })
                  .then(function(e) {
                    return e.data
                  })
              },
            ...
            },
            {
              ...
              value: function(e) {
                var t = _extends({}, e)
                return this.axiosConfiguration.get('users/current/summaries', { params: a(t) }).then(function(e) {
                  return e.data
                })
              },
            },
            {
              ...
              value: function(e) {
                ...
                return this.axiosConfiguration
                  .get('users/'.concat(t, '/stats/').concat(d[r]), { params: u(n) })
                  .then(function(e) {
                    return e.data
                  })
              },
            ...
            },
            {
              key: 'getProjects',
              value: function(e) {
                return this.axiosConfiguration.get('users/'.concat(e, '/projects')).then(function(e) {
                  return e.data
                })
              },
            },
            ...
            },
            {
              ...
              value: function() {
                var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
                  ...
                  n = e.pageNumber,
                  i = void 0 === n ? null : n
                return this.axiosConfiguration.get('leaders', { params: { language: r, page: i } }).then(function(e) {
                  return e.data
                })
              },
            },
            ...
            },
            {
              ...
              value: function(e) {
                var t = _extends({}, e)
                return this.axiosConfiguration.get('users/current/durations', { params: p(t) }).then(function(e) {
                  return e.data
                })
              },
            },
            {
              ...
              value: function(e) {
                ...
                return this.axiosConfiguration
                  .get('users/'.concat(t, '/projects/').concat(r, '/commits'), { params: c(n) })
                  .then(function(e) {
                    return e.data
                  })
              },
            },
            {
              ...
              value: function(e) {
                ...
                return this.axiosConfiguration
                  .get('users/current/projects/'.concat(t, '/commits'), { params: c(r) })
                  .then(function(e) {
                    return e.data
                  })
              },
      ...
      return new Promise(function dispatchHttpRequest(t, r) {
        ...
        if (_ && !n.isStream(_)) {
          if (Buffer.isBuffer(_)) {
            ...
            return b(g('Data after transformation must be a string, an ArrayBuffer, a Buffer, or a Stream', e))
          }
        ...
        if (A) {
          ...
          P.port = A.port
          P.path = C + '//' + T.hostname + (T.port ? ':' + T.port : '') + P.path
          if (A.auth) {
            var I = Buffer.from(A.auth.username + ':' + A.auth.password, 'utf8').toString('base64')
        ...
        var z = $.request(P, function handleResponse(t) {
          ...
          var n = t.req || z
          var s = { status: t.statusCode, statusText: t.statusMessage, headers: t.headers, config: e, request: n }
          if (e.responseType === 'stream') {
            ...
            r.on('data', function handleStreamData(t) {
              o.push(t)
              if (e.maxContentLength > -1 && Buffer.concat(o).length > e.maxContentLength) {
                r.destroy()
                b(g('maxContentLength size of ' + e.maxContentLength + ' exceeded', e, null, n))
              }
            })
        ...
        if (e.timeout) {
          f = setTimeout(function handleRequestTimeout() {
            z.abort()
            b(g('timeout of ' + e.timeout + 'ms exceeded', e, 'ECONNABORTED', z))
          }, e.timeout)
        }
        if (e.cancelToken) {
          e.cancelToken.promise.then(function onCanceled(e) {
  ...
  674: function(e, t, r) {
    ...
    function authenticate(e, t) {
      s(
        e.octokit.log,
        new n('[@octokit/rest] octokit.authenticate() is deprecated. Use "auth" constructor option instead.'),
      )
      if (!t) {
        e.auth = false
        return
    ...
    e.exports = {
      activity: {
        ...
        listPublicEventsForOrg: {
          method: 'GET',
          params: { org: { required: true, type: 'string' }, page: { type: 'integer' }, per_page: { type: 'integer' } },
          url: '/orgs/:org/events',
        },
      ...
      gists: {
        ...
        fork: { method: 'POST', params: { gist_id: { required: true, type: 'string' } }, url: '/gists/:gist_id/forks' },
      ...
      migrations: {
        ...
        unlockRepoForAuthenticatedUser: {
          headers: { accept: 'application/vnd.github.wyandotte-preview+json' },
          method: 'DELETE',
          params: { migration_id: { required: true, type: 'integer' }, repo_name: { required: true, type: 'string' } },
      ...
      reactions: {
        ...
        listForCommitComment: {
          ...
          params: {
            comment_id: { required: true, type: 'integer' },
            content: { enum: ['+1', '-1', 'laugh', 'confused', 'heart', 'hooray', 'rocket', 'eyes'], type: 'string' },
            owner: { required: true, type: 'string' },
            page: { type: 'integer' },
            per_page: { type: 'integer' },
            repo: { required: true, type: 'string' },
      ...
      teams: {
        ...
        delete: { method: 'DELETE', params: { team_id: { required: true, type: 'integer' } }, url: '/teams/:team_id' },
        deleteDiscussion: {
          headers: { accept: 'application/vnd.github.echo-preview+json' },
          method: 'DELETE',
          params: {
  ...
  753: function(e, t, r) {
    ...
    const p = withDefaults(n.endpoint, { headers: { 'user-agent': `octokit-request.js/${u} ${i.getUserAgent()}` } })
    t.request = p
  },
  761: function(e) {
    var t = 1e3
    ...
    function fmtLong(e) {
      return (
        plural(e, i, 'day') || plural(e, n, 'hour') || plural(e, r, 'minute') || plural(e, t, 'second') || e + ' ms'
      )
    }
  ...
  794: function(e, t, r) {
    ...
    function formatArgs(e) {
      ...
      e[0] =
        (r ? '%c' : '') + this.namespace + (r ? ' %c' : ' ') + e[0] + (r ? '%c ' : ' ') + '+' + t.humanize(this.diff)
      if (!r) return
  ...
  812: function(e) {
    e.exports = function isBuffer(e) {
      return (
        e != null && e.constructor != null && typeof e.constructor.isBuffer === 'function' && e.constructor.isBuffer(e)
      )
    }
  },
  814: function(e, t, r) {
  ...
  825: function(e, t, r) {
    ...
    e.exports = function mergeConfig(e, t) {
      t = t || {}
      var r = {}
      n.forEach(['url', 'method', 'params', 'data'], function valueFromConfig2(e) {
      ...
      const s = s => {
        ...
        Object.keys(s).forEach(r => {
          if (t.params[r] && t.params[r].deprecated) {
            ...
            e.log.warn(new n(`[@octokit/rest] "${r}" parameter is deprecated for "${i}". Use "${o}" instead`))
            if (!(o in s)) {
              s[o] = s[r]
            }
            delete s[r]
